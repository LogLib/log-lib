...
const Setting = async ({ params }: { params: { slug: string[] } }) => {
    ...
    const startDate =
        userWithBillingInfo?.billingCycleStart ?? userWithBillingInfo?.createdAt?.getDate();
            ...
            <TabModified defaultValue={route}>
                ...
                <TabsContent value="billing" className="flex flex-col max-w-[76rem] ">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-7">
                        <UsageCard title="sssWebsites" value={`${usage.websites}`} icon="layout" />
                        <UsageCard
                            title="Custom Events"
                    ...
                    <Card>
                        ...
                        <CardContent className=" space-y-4">
                            ...
                            <div className=" flex-grow">
                                ...
                                <Progress value={usage.customEvents * 100} className=" h-2 mt-2" />
