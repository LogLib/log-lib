...
function AppWindow({
    ...
    return (
        ...
        >
            ...
            >
                <div className={clsx("absolute left-4 top-0 flex h-10 items-center gap-1.5")}>
                    <div className={clsx("h-3 w-3 rounded-full bg-red-300", "dark:bg-slate-500")} />
                    <div
                        className={clsx("h-3 w-3 rounded-full bg-amber-300", "dark:bg-slate-500")}
                    />
                    <div
                        className={clsx("h-3 w-3 rounded-full bg-green-300", "dark:bg-slate-500")}
                    />
                </div>
                {type === "browser" && (
                    <>
