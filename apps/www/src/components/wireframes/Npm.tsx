...
function NpmWireframe({ packageName, description, isWithTypeScript = false }: NpmWireframeProps) {
    return (
        <div
            className={clsx(
        ...
        >
            ...
            <div className={clsx("mt-2 flex items-center gap-2 text-lg text-slate-400 ")}>
                <SkeletonSm w={60} />
            ...
            <div className={clsx("mt-4")}>
                <div className={clsx("flex")}>
                    ...
                    <div className={clsx("flex gap-2 border-b-2 border-orange-400 p-3 px-4")}>
                        <SkeletonSm />
                        <SkeletonSm w={54} />
                    </div>
                    <div className={clsx("flex gap-2 border-b-2 border-red-400 p-3 px-4")}>
                        <SkeletonSm />
                        <SkeletonSm w={72} />
                    </div>
                    <div className={clsx("flex gap-2 border-b-2 border-purple-400 p-3 px-4")}>
                        <SkeletonSm />
                        <SkeletonSm w={72} />
                    </div>
                    <div className={clsx("flex gap-2 border-b-2 border-sky-400 p-3 px-4")}>
                        <SkeletonSm />
                        <SkeletonSm w={48} />
                    </div>
                    <div className={clsx("flex gap-2 border-b-2 border-red-400 p-3 px-4")}>
